...
namespace large_numbers
{
    ...
    private:
        /**
         * @brief negate all the bits in the number, and after negation trim leading zeros
         * note : unlike fixed size ~ operator this operator does not reverse. i.e sometimes negate(negate(x)) != x
         * TODO : formalize it, using either fixed block size argument or storing of "negate back" block size
         * @return UInt 
         */
