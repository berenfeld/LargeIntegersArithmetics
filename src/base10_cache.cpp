...
namespace large_numbers
{
    namespace base10_cache
    {
        ...
        uint32_t makeKey(uint32_t digit_pos, uint32_t digit_value) { return digit_pos << 16 | digit_value; }
        ...
        UInt getUint(uint32_t digit_pos, uint32_t digit_value) { return _cache.at(makeKey(digit_pos, digit_value)); }
    } // namespace base10_cache
} // namespace large_numbers